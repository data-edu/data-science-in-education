...
It appears that the model with the value of the **mtry** tuning parameter equal to 43 seemed to explain the data best, the **splitrule** being "extratrees", and **min.node.size** held constant at a value of 5. We know this model fits best because
