...
<!-- Note - right now, this data does not contain any retweets, though if we search tidytuesday and augment the existing tweets with these, we should have enough to get started with this. -->
...
We'll use a regular expression, or regex, to do so, from [here](https://stackoverflow.com/questions/18164839/get-twitter-username-with-regex-in-r
...
### An example of a selection model
