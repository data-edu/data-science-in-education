...
- Resources on programming with R
- Helpful package vignettes and descriptions of packages
- Statistics resources
- Resources on R packages and statistical software development
...
Penuel, W. R., Briggs, D. C., Davidson, K. L., Herlihy, C., Sherer, D., Hill, H. C., & Allen, A. R. (2016, April). *Findings from a national study on research use among school and district leaders*. http://bit.ly/ncrpp-report
