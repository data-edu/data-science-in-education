...
First, you will need to download the latest versions of R and R Studio. R is a free environment for statistical computing and graphics using the programming language R. R Studio is a set of integrated tools that allows for a more user-friendly experience for writing in R.

Although you will likely use R Studio as your main editor, you must first install R, as R Studio uses R behind-the-scenes. Both are freely-available, cross-platform, and open-source.
...
The documentation should tell you what the function does, what arguments (details) needed for it to successfully run, examples, and what the output should look like.
...
_For more information, check out DataCamp's [Beginner's Guide to R Packages](https://www.datacamp.com/community/tutorials/r-packages-guide).
