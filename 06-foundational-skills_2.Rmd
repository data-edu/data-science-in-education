...
Once you've installed the `dataedu` package (described above), you can use the `mass_install()` function to download all of the packages we'll be using in this text. 
