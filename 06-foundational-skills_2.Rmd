...
### Run this code
Take a few minutes to type out and run each of the following lines of code:  
...
Talk about `arrange()` and additional functions
add in metacognition around functions
```{r, eval = FALSE}
ma_data_init %>%
    group_by(`District Name`) %>%
    count() %>%
