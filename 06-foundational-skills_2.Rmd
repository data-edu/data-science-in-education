...
This works because the `data()` function is part "base R"---it's included with R when you first install it. However, as you saw in a previous section, we'll be asking you to install additional packages. 
