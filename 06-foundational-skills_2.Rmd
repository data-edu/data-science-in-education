...
```{r, fig.cap = "Error message when running ?mutate", echo = FALSE}
knitr::include_graphics("./man/figures/Image 6.1.png")
```
...
```{r, fig.cap = "Image of the Packages Pane", echo = FALSE}
knitr::include_graphics("./man/figures/Image 6.2.png")
```
