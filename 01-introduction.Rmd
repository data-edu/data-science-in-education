...
As data science in education grows, the way we talk about and conceptualize it also needs to grow; doing so can help us to advance data science in education as a discipline and to speak to the unique opportunities and concerns that arise with analyzing data in our domain. Some of the time, for instance, data science in education refers to *the application of data science methods*, while other times it refers to data science as a context for teaching and learning [@rosenberg2020mdsc]. Our emphasis in this book is primarily on the former - applying data science methods to ask and answer questions and identify and solve problems related to education. However, in [Chapter 17](#c17), we also describe some of the (growing) scholarship on what is know about how to effectively teach data science to learners.

We begin this book by offering a primer for data science in education, including a discussion of unique challenges and foundational skills in the programming language R. This includes this chapter as well as suggestions for how to use this text ([Chapter 2](#c02)), our definition of data science in education and articulation of what we think it "looks like" ([Chapter 3](#c03)), and a discussion of data science in education in the context of the wider fields of both education and data science ([Chapter 4](#c04)).
