...
Then there's the challenge of how education systems can best use data science tools. In many education settings, school staff have never worked with someone with that blends education content knowledge, programming, and statistics --- the "Data Science Venn Diagram" [@conway2010data].
