...
In the context of modeling the dataset, we note that there are other techniques
...
and multi-level models [@west2014linear], are especially helpful for testing hypotheses about change over time--and what predicts it. Both of the references cited above include R code for carrying out such analyses.
