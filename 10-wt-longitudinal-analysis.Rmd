...
```{r fig10-1, results = 'hide', message = FALSE, warning = F, fig.cap = "Count of Female Students in Special Education Over Time"}
high_count %>%
...
```{r fig10-2, results = 'hide', message = FALSE, fig.cap="Count of Male Students in Special Education Over Time"}
high_count %>%
...
```{r fig10-3, results = 'hide', message = FALSE, fig.cap="Total Count of Students in Special Education Over Time"}
high_count %>%
  group_by(year, state) %>%
...
```{r fig10-4, results = 'hide', message = FALSE, fig.cap="Median Students with Disabilities Count"}
high_count %>%
  group_by(year, state) %>%
  summarize(n = sum(total)) %>%
...
```{r fig10-5, results = 'hide', message = FALSE, fig.cap="Male Student to Female Student Ratio Over Time"}
high_count %>%
...
```{r fig10-6, results='hide', message = FALSE, fig.cap="Comparison of Female Students to Male Students in Special Education"}
child_counts %>%
...
```{r fig10-7, results = 'hide', message = FALSE, fig.cap = "Comparison of Female Students to Male Students with Disabilities"}
child_counts %>%
  filter(age == "Total, Age 6-21") %>%
  pivot_wider(names_from = gender, 
              values_from = total) %>%
...
```{r fig10-8, results = 'hide', message = FALSE, fig.cap="Male to Female Ratio Across Years (Jittered)"}
...
```{r fig10-9, results = 'hide', message = FALSE, fig.cap="Median Male and Female Student Counts in Special Education"}
model_data %>%
