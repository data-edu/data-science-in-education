...
data at mutiple time points. While data from two time points would be included in 
...
For this walkthrough, we'll be using four packages: {tidyverse}, {here},
{dataedu}, and {lubridate} [@R-lubridate]; of these, {lubridate} is the sole
package we have not used previously. You can load those packages by running this
code: 
...
available through the {dataedu} package. Last, we note that while t's possible to use this
...
Here is how we would do it for the first dataset (from the year 2012).

```{r, eval = FALSE}
download.file(
  # the url argument takes a URL for a CSV file
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2012.csv', 
...
```{r, eval = FALSE}
download.file(
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2013.csv', 
  destfile = here("data",
           "longitudinal_data",
           "bchildcountandedenvironments2013.csv"))

download.file(
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2014.csv', 
  destfile = here("data",
           "longitudinal_data",
           "bchildcountandedenvironments2014.csv"))

download.file(
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2015.csv', 
  destfile = here("data",
           "longitudinal_data",
           "bchildcountandedenvironments2015.csv"))

download.file(
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2016.csv', 
  destfile = here("data",
           "longitudinal_data",
           "bchildcountandedenvironments2016.csv"))

download.file(
  url = 'https://github.com/data-edu/data-science-in-education/raw/master/data/longitudinal_data/bchildcountandedenvironments2017-18.csv', 
  destfile = here("data",
           "longitudinal_data",
...
ready to proceed to reading the data into R.
...
filenames <-
  list.files(path = here("data", "longitudinal_data"),
             full.names = TRUE)
...
If you did not (or could not, if you did not have Internet access) access and process the datasets and would like to load this processed dataset (`child_counts`), then
...
rows where the `f` variables has a value that is less than or equal to 500000.
...
about 2 male students to every female student, we can present these two ideas
