...
_Note: After step 3, "Comine six datasets into one," you'll have a dataset stored in an object `longitudinal_data`. Alternatively, you can skip steps 1-3 and instead start this procedure at the section called "Importing the data from the {dataedu} package."_
