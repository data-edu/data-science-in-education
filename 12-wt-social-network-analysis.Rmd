...
To do so, you'll need to visit XXX in a browser.
...
```{r}
posts_nov <- bs_search_posts(query = "#tidytuesday", 
                             since = '2022-11-01T00:00:00.000Z', until = '2022-11-30T23:59:59.000Z',
                             limit = 10000,
                             auth = auth)

posts_dec <- bs_search_posts(query = "#tidytuesday", 
                         since = '2024-12-01T00:00:00.000Z', until = '2024-12-31T23:59:59.000Z',
                         limit = 10000,
                         auth = auth)
...
bind_rows(posts_nov, posts_dec, posts_jan) -> posts
```
