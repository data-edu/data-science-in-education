...
-   How do relationships between teachers support their implementation of new curricula?

-   How do gaps in students'
...
posts_flattened %>%
    unnest_wider(col = reply_to, names_sep = " ") %>% 
    janitor::clean_names() %>% 
    unnest_wider(col = reply_to_parent, names_sep = " ") %>% 
    unnest_wider(col = reply_to_root, names_sep = " ") %>% View()
```
