...
An edgelist looks like the following, where the `sender` column identifies who is initiating the interaction and the `receiver` column identifies who is receiving the interaction:
