...
- `mutate(has_mention = ifelse(!is.na(all_mentions), TRUE, FALSE))`: this line simply determines if there are any mentions at all (or not); it is true if there is one or more mention
