...
You've been reading through a tutorial and have come across the `coalesce()` function. 
...
* Are there any examples from the Help documentation that seem similar to what you're trying to accomplish? If so, choose one.
