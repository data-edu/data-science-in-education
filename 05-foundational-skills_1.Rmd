...
## RStudio environment, layout, and customization: getting to know R through RStudio
...
<center>
![RStudio layout]()(https://i.imgur.com/2rhZmMg.png?1)
</center>  
...
Tjere are three ways to run code in an `.R` script:  
