...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Bar Graph of Student Grades"}
...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Classwork Scores"}
...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Relationship Between Overall Grade and Formative Assessments"}  
...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Relationship Between Overall Grade and Formative Assessments (with Line of Best Fit)"}  
# Scatterplot between formative assessment and grades by percent
# To determine linear relationship
...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Formative Assessment Scores"}  
...
```{r, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Overall Grade Scores"}  
