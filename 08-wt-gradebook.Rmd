...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Bar Graph of Student Grades"}
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Classwork Scores"}
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Relationship Between Overall Grade and Formative Assessments"}  
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Relationship Between Overall Grade and Formative Assessments (with Line of Best Fit)"}  
# Scatterplot between formative assessment and grades by percent
# To determine linear relationship
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Formative Assessment Scores"}  
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Distribution of Overall Grade Scores"}  
