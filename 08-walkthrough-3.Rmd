...
Using the simpler model without treating `min.node.size` as a tuning parameter, let's explore predicted values. In particular, we can see how predicted values compare to those in the test set to understand predictive accuracy.
...
## Value importance measures

Random forests can generate variable importance measures.
