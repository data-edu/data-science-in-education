---
title: 'Education Dataset Analysis Pipeline: Walkthrough #3'
...
d_train <- mutate(d_train, 
                  pred = predict(rf_fit, d_train),
                  obs = final_grade, # this is to calculate summmary statistics using caret
                  raw_diff = y_pred - final_grade,
                  abs_diff = abs(y_pred - final_grade))
...
We note that some of the most predictive measures are *trace* measures (from the discussion post and time spent on the course data). Data on students' motivation are less important - but still noteworthy - predictors of final grade.
