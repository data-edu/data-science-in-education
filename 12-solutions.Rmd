...
Quickly answering analytic questions has a chain effect. It works something like this: When a consultant quickly answers a teacher's analytic question about their students' latest batch of quiz scores, the collaborative analytic process feels more like a fast-paced inspiring conversation with a teammate instead of sluggish correspondence between two people on opposite ends of the country. It's possible to take so long to answer a question like "Is this batch of quiz scores meaningfully different from the ones my students had six months ago?" that the question itself is unimportant by the time the answer arrives! These are the perils of working in a fast-paced education environment where the nature of information teachers want to make daily decisions changes frequently. Doing things quickly helps people. Helping people builds confidence. Confidence builds innovation. 
...
Preparing data is an example of an activity that gets much faster when using data science techniques. Imagine you are a consultant for a school that uses an online quiz system and each teacher's quiz export looks like this:
