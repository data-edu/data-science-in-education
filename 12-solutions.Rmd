...
30
The truth is, there is no guarantee that all your teammates will be equally excited about using data science tools as you are. That does not mean that there is no place in your organization for a creative data scientist like yourself! The trick is to put yourself in the shoes of your coworkers when they feel excited, timid, skeptical, or even dismissive of the idea of bringing statistics and programming into the conversation about how to improve the experience of students. Data scientists get equal amounts of joy from solving problems and coding solutions. But non data scientists are all about solving the problems. When we use empathy to connect with our coworkers about the common problems and questions we are engaging, we open the door to all kinds of solutions, including the introduction of data science techniques. 
31
Work places that are not used to the speed and scale that programming can bring to datawork need expansion of their expectations in just that--speed and scale! Use your empathy skills to imagine the extend of modern data work. Cleaning is done by hand using tools like Excel. Cleaning and statistics techniques are applied to one dataset at a time instead of hundreds at a time. And when a project is complete, the steps needed to complete that project are lost unless they were dutifully documented by the analyst. 

 1. What does it look like when we do data analysis today? 
 1. What does the future of data analysis in your education workplace look like in your imagination? 
 1. What is the next baby step that takes you from where you are today and where you will be in the future? 
...
You may just need to do it first then show it. 
