...
This is a good place to think carefully about which variables we pick. Let's go through each one. 
...
Since we know that a) each of our six datasets had six variables and b) our combined dataset also has six variables, we can conclude that all our rows combined together correctly. But let's use `str` to verify: 
