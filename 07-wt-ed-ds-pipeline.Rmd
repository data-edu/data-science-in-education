...
```{r fig7-1, warning = FALSE, message = FALSE, results = 'hide', fig.cap = "Example Plot"}
...
``` {r fig7-2, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Percentage Earned vs. Time Spent"}
dat %>%
...
``` {r fig7-3, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Adding a Line of Best Fit"}
dat %>%
  ggplot(aes(x = TimeSpent, y = percentage_earned)) +
