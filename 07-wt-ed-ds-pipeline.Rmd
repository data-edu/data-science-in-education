...
wered designed and taught by instructors through a statewide online course provider
...
sudents' spent on the course. We will also explore how different (science) 
...
```{r ggplot example, warning = FALSE, results = 'hide'}
# make dataset
students <- 
  tibble(
    school_id = c("a", "b", "c"), 
