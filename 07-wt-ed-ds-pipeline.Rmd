...
For this and the remaining walkthroughs, we refer to the topics emphasized in terms of one of five
aspects of doing data science: 

1. Cleaning data: Selecting and naming columns and filtering or recoding incomplete cases of data (sometimes referred to as taming or wrangling data)
2. Tidying data: Joining or combining two or more data frames and pivoting data from "long" to "wide" form to facilitate data visualization or modeling
3. Exploring data: Checking, counting, and summarizing data
4. Visualizing data: Creating visualizations to understand data and to present output from analyses
5. Modeling data: Using statistical models, from simple to complex, to understand trends and patterns in data

While we use these five terms to categorize the topics emphasized in the walkthroughs, we do not think that these are the *only* five aspects of doing data science; @peng2015 and @grolemund2018 for slightly different depictions of the aspects of data science and how they work together when it comes to doing data science.

As mentioned in [Chapter 5](#c05), then, these topics emphasized are those that are the *particular* focus of each chapter; most of the walkthroughs contain some element of all of the five aspects, but all have specific emphases. For this chapter on the educaton data science pipeline, those emphases are:
