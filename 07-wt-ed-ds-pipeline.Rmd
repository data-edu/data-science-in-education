...
It looks like we have `r scales::comma(nrow(joined_dat))` observations of `r ncol(joined_dat)` variables.
...
```{r fig7-2, warning = FALSE, message = FALSE, results = 'hide', fig.showtext = TRUE, fig.cap = "Example plot"}
...
``` {r fig7-3, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Percentage earned vs. time spent", fig.showtext = TRUE}
...
``` {r fig7-4, message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Adding a line of best fit", fig.showtext = TRUE}
