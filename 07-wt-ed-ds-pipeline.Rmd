...
For this and the remaining walkthroughs, we refer to the topics emphasized in terms of different 
aspects of doing data science. In this book, we use the six aspects of doing data science from @grolemund2018's depiction. 

These, with definitions, are:
...
While we use these aspects to categorize the topics emphasized in the walkthroughs, we do not think that these are necessarily the *only* aspects of doing data science; @peng2015, for example, presents a different description of data science that emphasizes its iterative nature. Nevertheless, particularly given our use of many R packages and techniques that work well with tidy data (see *tidying data* above; @wickham2019), we think these aspects satisfactorily describe the process of doing data science for us to use them for our purposes.

As mentioned in [Chapter 5](#c05), then, the topics emphasized are those that are the *particular* focus of each chapter; most of the walkthroughs contain some element of all of the five aspects, but all have specific emphases. For this chapter on the educaton data science pipeline, those emphases are:
