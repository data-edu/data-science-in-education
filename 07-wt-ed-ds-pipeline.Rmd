...
function; the names of the packages must be provided to the function as follows^[the `c()` function used here creates a *character vector* of the names of packages that are provided to `install.packages`]:
