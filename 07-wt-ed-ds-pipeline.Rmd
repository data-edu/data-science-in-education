...
## Load Packages: List of ALL packages used in the analysis, message = F (but no extra packages)

## Import Data: Load ALL data to be used in the analysis, use descriptive names
...
## Introduction: quick summary of the problem to solve/opportunity to attain
