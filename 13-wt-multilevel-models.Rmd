...
We can see how dummy coding works through using the {dummies} package, though you often do not need to manually dummy code variables like this.
...
student) of being in a specific class in the data set. We will load a built-in dataset from the {dataedu} package. 
