...
If you have not before, you'll need to install {lme4}, {performance}, and {dummies} once to do the rest of this walkthrough. To install these, type (or copy) this code in your console:

```{r install lme4, eval=FALSE}
install.packages(c("lme4", "performance", "dummies")) 
```
