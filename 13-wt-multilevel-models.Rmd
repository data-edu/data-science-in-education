...
We can see this easiest if we just select the `species` variable and the three new dummy-coded variables, and looking at just the first 5 rows to examine and check:
