...
Aggregate data are essential both for accountability purposes and for providing
...
At the state and district levels, some examples include the following from two states:
