...
This walkthrough builds upon and extends the focus on aggregate data in [the last chapter](#c09) to focus on change over time in students with disabilities in each state.
