...
different ways to use the book, both as a reader and as a contributor. Here are some ways to use this book:   

## Read the Book Cover to Cover and Try All the Walkthroughs 

We wrote this book assuming you are just starting your journey learning R and using data science in your education job. Writing it this way allows for a reading experience that takes you from installing R to a chance to practice fairly advanced data science skills like text analysis. 
...
One last note on this way of using the book: we believe that doing data science in R is, at its heart, an endeavor aimed at improving the student experience. This mission involves complex problems, and complex problems require many people to solve. Be sure to read other areas of the book that give context to why and how we do this work. Chapter Twelve in particular explores ways to introduce these skills to your education job and invite others into analytic activities.
...
Our vision for the book is to be the book new data scientists in education have with them as they grow their craft. We can realize this vision best if the stories and examples in the book our based on **your** stories and examples. We've built ways for you to share with us into our process. Here are some ways readers can contribute: 
 ...
 [GitHub site](https://github.com/jrosen48/data-science-in-education) that describes a data science problem that is unique to the education setting 
 ...
 We thank you for your interest in building out the use of R and data science in this multi-faceted, diverse field!
