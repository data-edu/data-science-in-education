...
When we run the `dummy()` function on the `Species` variable, it
returns *three* variables, one for each of the three levels of Species - `setosa`, `versicolor`, and `virginica`.
