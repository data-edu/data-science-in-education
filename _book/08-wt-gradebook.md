...
Make sure you have installed the packages in R on your computer before starting (see [Foundational Skills](#c05) chapter). Load the libraries, as they must be loaded each time we start a new project.
