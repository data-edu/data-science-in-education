...
But once an organization has clearly defined their equity-related goals, it can use its data science routines to advance those goals through learning and decision making.
...
R and RStudio, both freely available and open, also serve to increase equity in data science. As opposed to proprietary tools, they are accessible to anybody with a computer and internet. The code behind the packages is available online, making its processes and design choices transparent. 
