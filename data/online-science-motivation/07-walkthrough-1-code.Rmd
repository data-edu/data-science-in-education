...
RR_Course_Data <- read_csv(f)

f <- here::here("data", "online-science-motivation", "raw", "CS1.csv")
CS1 <- read_csv(f) # this is the pre-survey for the Fall, 2015 and Spring, 2016 semesters
```
