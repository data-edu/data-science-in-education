´---
title: "New Analysis for MVS UV Study"
...
RR_Course_Data <- read_csv(here::here("data", "online-science-motivation", "raw", "RR_Course_Data.csv"))

# Pre-survey for the F15 and S16 semesters
CS1 <- read_csv(here::here("data", "online-science-motivation", "raw", "CS1.csv")) 

# Post-survey for the F15 and S16 semesters
...
# Log-trace data for F15 and S16 semesters?
ts_12 <- read_csv(here::here("data", "online-science-motivation", "raw", "RR_Minutes.csv"))
