...
"Understanding the develop- mental, cultural, contextual, and historical diversity of learners is central to understanding how people learn."

### Learners learn many different things (consciously and unconsciously)

integrateds many types of learning in response to challenges and circumstances

### Self-regulation and monitoring are important

df

### Prior knowledge can help (or hurt)

asd

### Helping students retrieve information and to summarize and explain what they are learning, as well as spacing and structure of instruction, matter

Instructional design matters, unfortunately

### Motivation depends on goals as well as the sociocultural context (and sense of belonging)

sdf

### Educators can help students to learn (helping them set goals, support value and control and autonomy, support competence, create a supportive and non-threatening environment)
