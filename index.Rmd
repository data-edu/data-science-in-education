...
When you work as a data science consultant in education or as an educator learning data science, it’s hard to find a professional community that gets you. Going to education conferences is great, but the eyes glaze over when you talk about regression models. The data science conferences are super, but folks leave the cocktail table when you vent about the state of aggregate test score data. 
