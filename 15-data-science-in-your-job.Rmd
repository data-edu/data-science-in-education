...
Second, ask them if you can "borrow the problem." "Borrowing a problem" is not solving it for them, it's using data science to get them unstuck so they can continue working the problem. For example, if they're struggling to make a scatter plot, offer clean and summarize the dataset before they try again. 
