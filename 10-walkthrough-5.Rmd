...
Now that we understand the distribution and variance within the groups in our data, we can compare these datapoints.
...
We can start to answer our first research question:
